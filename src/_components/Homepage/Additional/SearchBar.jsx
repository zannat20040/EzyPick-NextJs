    ...
    <div className="relative mx-auto shadow-none border border-gray-200">
      <div className="flex items-center rounded-md shadow-none">
        ...
        <button
          ...
          className={`bg-slate-800 p-3 rounded-none text-center text-sm text-white transition-all hover:bg-pale-red border-l ${
            loading ? "bg-pale-red" : ""
          } border-gray-200 group disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none`}
          type="button"
        >
          {loading ? (
